---
title: "bpmodels: Theoretical background"
...
vignette: >
  ...
  %\VignetteIndexEntry{bpmodels: Theoretical background}
...
$$
where $\mathbf{1}$ is the indicator function and $x_$ the i-th observed chain size (or length, if the interest is in $L$).
